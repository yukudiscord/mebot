...
        .addField("OTHER","`me!embed - сказать сообщение embed`\n`me!say` - сказать что-то от именни бота\n`me!ping` - проверить нагрузку на бота\n`me!report` [Юзер] <ПРИЧИНА> - написать репорт на человека")
        .addField("MODER","`me!kick` [Юзер] <ПРИЧИНА> - кикнуть пользователя\n`me!ban` [Юзер] <ПРИЧИНА> - забанить пользователя\n`me!report` [Юзер] <ПРИЧИНА> - написать жалобу\n`me!server` - проверить информацию про данный сервер\n`me!mute` [Юзер] <ВРЕМЯ> - замутить пользователя")
        .addField("FUN","`me!hi` [Юзер] - сказать привет человеку\n`me!hi` - сказать всем привет!\n`me!sad` - уйти в печаль\n`me!angry` [Юзер] - злится на человека\n`me!angry` - начать злится\n`me!sleep` - пойти спать\n`me!suicide` - умереть\n`me!smoke` - покурить сигу")
        try {
